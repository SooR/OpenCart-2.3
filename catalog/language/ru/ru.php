...
// Ajax load page
$_['text_show_next']        = 'Показать еще {show} {items}';
$_['text_show_allp']         = 'Показано {show} {items} из {shows}';
$_['text_loading']          = 'Загрузка...';
$_['text_no_more_show']     = 'Больше нечего показывать';
$_['text_d1_items']         = 'товар';
$_['text_d2_items']         = 'товара';
$_['text_d3_items']         = 'товаров';
