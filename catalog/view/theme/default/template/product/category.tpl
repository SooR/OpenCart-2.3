...
<!-- Ajax load page -->
<script>
    var text_show_next = '<?php echo $text_show_next; ?>',
        text_show_all = '<?php echo $text_show_allp; ?>',
        text_loading = '<?php echo $text_loading; ?>',
        text_no_more_show = '<?php echo $text_no_more_show; ?>',
        text_d1_items = '<?php echo $text_d1_items; ?>',
        text_d2_items = '<?php echo $text_d2_items; ?>',
        text_d3_items = '<?php echo $text_d3_items; ?>';
</script>
<!-- Ajax load page -->
<?php echo $footer; ?>
